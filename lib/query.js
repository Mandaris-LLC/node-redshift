...
function runQuery(that, client, query, parameters, opts, resolve, reject, done, endConnection) {
  const queryFromClient = client.query(query, parameters, function (err, data) {
  ...
  if (opts && opts.onQueryInstance && typeof opts.onQueryInstance === 'function') {
    opts.onQueryInstance(queryFromClient)
  }
}
